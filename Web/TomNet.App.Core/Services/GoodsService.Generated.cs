...
namespace TomNet.App.Core.Services
{
    ...
    {   		
        ...
        /// 仓储对象
        /// </summary>
		IRepository<Goods, int> _repository;
        ...
        public GoodsService(IServiceProvider provider)
        {
			...
			_repository = _serviceProvider.GetService<IRepository<Goods, int>>();
        ...
        /// 当前实体类型的查询数据集
        /// </summary>
        public ISugarQueryable<Goods> Entities { get; }
        ...
        public Task<int> InsertAsync(Goods entity)
        {
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(List<Goods> entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(List<Goods> entities)
        {
        ...
        public Task<int> InsertAsync(Goods[] entities)
        {
            return _repository.InsertAsync(entities);
        }
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public Goods InsertReturnEntity(Goods entity)
        {
            return _repository.InsertReturnEntity(entity);
        }

        public Task<Goods> InsertReturnEntityAsync(Goods entity)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Goods entity, string[] ignoreColumns = null)
        {
            return _repository.Update(entity, ignoreColumns);
        }

        public Task<int> UpdateAsync(Goods entity, string[] ignoreColumns = null)
        {
        ...
        /// <param name="ignoreColumns">不更新的列</param>
        /// <returns>操作影响的行数</returns>
        public int Update(List<Goods> entitys, string[] ignoreColumns = null)
        {
            return _repository.Update(entitys, ignoreColumns);
        }

        public Task<int> UpdateAsync(List<Goods> entitys, string[] ignoreColumns = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Expression<Func<Goods, Goods>> update, Expression<Func<Goods, bool>> predicate = null)
        {
            return _repository.Update(update, predicate);
        }

        public Task<int> UpdateAsync(Expression<Func<Goods, Goods>> update, Expression<Func<Goods, bool>> predicate = null)
        {
        ...
        public Task<int> DeleteAsync(Goods entity)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Delete(Expression<Func<Goods, bool>> predicate)
        {
            return _repository.Delete(predicate);
        }

        public Task<int> DeleteAsync(Expression<Func<Goods, bool>> predicate)
        {
        ...
        public Goods GetFirst(Expression<Func<Goods, bool>> predicate)
        {
            return _repository.GetFirst(predicate);
        }

        public Task<Goods> GetFirstAsync(Expression<Func<Goods, bool>> predicate)
        {
