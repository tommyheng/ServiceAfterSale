...
namespace TomNet.App.Core.Services
{
    ...
    /// 服务类 Express
    /// </summary> 
	public partial class ExpressService : IExpressContract
    {   		
		/// <summary>
        /// 服务提供者
        /// </summary>
        ...
        /// 仓储对象
        /// </summary>
		IRepository<Express, int> _repository;

		/// <summary>
        /// 构造函数
        /// </summary>
        public ExpressService(IServiceProvider provider)
        {
			_serviceProvider = provider;
			_repository = _serviceProvider.GetService<IRepository<Express, int>>();
        ...
        /// 当前实体类型的查询数据集
        /// </summary>
        public ISugarQueryable<Express> Entities { get; }
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(List<Express> entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(List<Express> entities)
        {
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(Express[] entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(Express[] entities)
        {
            return _repository.InsertAsync(entities);
        }
        ...
        /// <param name="ignoreColumns">不更新的列</param>
        /// <returns>操作影响的行数</returns>
        public int Update(List<Express> entitys, string[] ignoreColumns = null)
        {
            return _repository.Update(entitys, ignoreColumns);
        }

        public Task<int> UpdateAsync(List<Express> entitys, string[] ignoreColumns = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Expression<Func<Express, Express>> update, Expression<Func<Express, bool>> predicate = null)
        {
            return _repository.Update(update, predicate);
        }

        public Task<int> UpdateAsync(Expression<Func<Express, Express>> update, Expression<Func<Express, bool>> predicate = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Delete(Expression<Func<Express, bool>> predicate)
        {
            return _repository.Delete(predicate);
        }

        public Task<int> DeleteAsync(Expression<Func<Express, bool>> predicate)
        {
        ...
        public Express GetFirst(Expression<Func<Express, bool>> predicate)
        {
            return _repository.GetFirst(predicate);
        }

        public Task<Express> GetFirstAsync(Expression<Func<Express, bool>> predicate)
        {
