...
namespace TomNet.App.Core.Services
{
    ...
    /// 服务类 RepairListInfo
    /// </summary> 
	public partial class RepairListInfoService : IRepairListInfoContract
    {   		
		/// <summary>
        /// 服务提供者
        /// </summary>
        ...
        /// 仓储对象
        /// </summary>
		IRepository<RepairListInfo, int> _repository;

		/// <summary>
        /// 构造函数
        /// </summary>
        public RepairListInfoService(IServiceProvider provider)
        {
			_serviceProvider = provider;
			_repository = _serviceProvider.GetService<IRepository<RepairListInfo, int>>();
        ...
        /// 当前实体类型的查询数据集
        /// </summary>
        public ISugarQueryable<RepairListInfo> Entities { get; }
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(List<RepairListInfo> entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(List<RepairListInfo> entities)
        {
        ...
        /// </summary>
        /// <returns>操作影响的行数</returns>
        public int Insert(RepairListInfo[] entities)
        {
            return _repository.Insert(entities);
        }

        public Task<int> InsertAsync(RepairListInfo[] entities)
        {
            return _repository.InsertAsync(entities);
        }
        ...
        /// <param name="ignoreColumns">不更新的列</param>
        /// <returns>操作影响的行数</returns>
        public int Update(List<RepairListInfo> entitys, string[] ignoreColumns = null)
        {
            return _repository.Update(entitys, ignoreColumns);
        }

        public Task<int> UpdateAsync(List<RepairListInfo> entitys, string[] ignoreColumns = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(Expression<Func<RepairListInfo, RepairListInfo>> update, Expression<Func<RepairListInfo, bool>> predicate = null)
        {
            return _repository.Update(update, predicate);
        }

        public Task<int> UpdateAsync(Expression<Func<RepairListInfo, RepairListInfo>> update, Expression<Func<RepairListInfo, bool>> predicate = null)
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Delete(Expression<Func<RepairListInfo, bool>> predicate)
        {
            return _repository.Delete(predicate);
        }

        public Task<int> DeleteAsync(Expression<Func<RepairListInfo, bool>> predicate)
        {
        ...
        public RepairListInfo GetFirst(Expression<Func<RepairListInfo, bool>> predicate)
        {
            return _repository.GetFirst(predicate);
        }

        public Task<RepairListInfo> GetFirstAsync(Expression<Func<RepairListInfo, bool>> predicate)
        {
